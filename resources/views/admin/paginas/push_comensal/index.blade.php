...
<div id="wrappermini">
    <div id="one" style="margin: 0px; padding: 0px; ">  
        ...
        <div style="background-color: #a9a9a9; color: #f0f0f0; padding: 1px; min-height: 65px; max-height: 190px; max-width: 900px; min-width: 300px;">
            <div style=" display: inline-block; margin-left: 15px; margin-right: 25px;">
                <a href="#"><img src="../images/monitor.png" height="40px" width="40px" style="margin-left: 4px; margin-right: 20px;" /></a>
                <a href="#"><img src="../images/tablet.png" height="35px" width="24px" /></a>
            </div>
        ...
        <form>
            <div id="contentConfig" style="background-color: #fdfdfd; color: #444; padding: 1px; height: 800px; max-width: 900px; min-width: 300px;">
...
<script>
    ...
    { 
        ...
        div1.style = "width: 240px; float: left; background-color: #e9e9e9; height: 800px; color: #444;"; 
        addImageToUpload(div1, "imgcampain", "Agregar una imagen", function(){ readURL(this, "#imgcampain"); }); 
        cc.appendChild(div1);
        
        var div2 = document.createElement("div");
        div2.style = "max-width: 600px; min-width: 300px; float: left; margin: 0; padding: 0; color: #444; overflow-x: auto;";
        ...
        table1.style = "color: #000; width: 600px;";
    ...
    function onContinuar(){
        ...
        var div1 = document.createElement("div");
        div1.style = "min-width: 250px; max-width: 800px; background-color: #eeeeee; color: #777; margin: 0 auto; ";
        ...
        select1.style = "margin: 8px 25px 8px 8px;";
        select1.name = "audiencia";
        for(i=0; i<10; i++){
            var option1 = document.createElement("option");
            option1.value = "val " +i.toString();
            option1.innerHTML = "opcion " + i.toString();
        ...
        input1.val = "0.001";
        input1.name = "radius";
        input1.style = "margin: 8px 25px 8px 8px;"; 
        
        var label3 = document.createElement("label");
        label3.innerHTML = "Usuario localizados"; 
        ...
        createTipoCelular(div11, 1, 1);
        createTipoCelular(div11, 0, 58);     
    ...
    {  
        ...
        var thead1 = table1.createTHead(); 
        var rowHead = thead1.insertRow(0);
        rowHead.style = "background-color: #777; color: #f7f7f7;";
        var cell0 = document.createElement("th");
        var cell1 = document.createElement("th");
        var cell2 = document.createElement("th");
        var cell3 = document.createElement("th");
        ...
        for(i=0; i<10; i++) //para cada fila
        {
            ...
            tr2.style = "background-color: #eeeeee; border-bottom: 4px solid #fff;";
            ...
            createTipoCelular(td22, 1, 1);
            createTipoCelular(td22, 0, 58);   
