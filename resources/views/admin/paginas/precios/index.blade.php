...
<section class="content" style="float: none; width: 100%; padding: 0px; ">
    ...
    <div style="width: 70%; background-color: #a52a2a; height: 55px; color: #fff; margin-top: 12px;">
        <h2 style="float: right; padding-right: 50px; margin-top: 10px;">ARMA TU SOLUCION</h2>
    </div>
    
    <div style="width: 70%; background-color: #dcdcdc; height: 400px;margin-top: 50px; margin-left: 280px;">
